...
$result2 = $shoppingCart->addProduct(3, 20, $products);
echo "<p>Adicionar 20 Smart TVs: {$result2}</p>";

$result3 = $shoppingCart->removeProduct(1, $products);
echo "<p>Remover Smartphone do carrinho: {$result3}</p>";

$result4 = $shoppingCart->applyCoupon('DESCONTO10');
echo "<p>Aplicar cupom DESCONTO10: " . ($result4 ? "Cupom aplicado" : "Cupom inválido") . "</p>";
